    ...
    return [
        {
            ...
            create() {
                ...
                cancelButton.className =
                    "font-sans p-1 px-2 text-muted-foreground hover:text-foreground hover:bg-foreground/10 rounded-sm cursor-pointer";
...
export const quickEdit = (fileName: string) => {
    ...
    return [quickEditState, quickEditTooltipField, quickEditKeymap, captureViewExtension];
};
